...
with open(csv_file, mode='a', newline='', encoding='utf-8') as file:
    ...
    while True:
        ...
        while True:
            ...
            unclear_phrases = ["not sure", "idk", "unsure", "repeat", "again", "what do you mean", "unclear", "confused"]
            clear_yes_no = ["yes", "no", "yeah", "nope", "yep", "nah", "maybe", "don't know"]
            user_clean = user_input.strip().lower()

            if (
                user_clean not in clear_yes_no and
                (any(p in user_clean for p in unclear_phrases))
            ):
